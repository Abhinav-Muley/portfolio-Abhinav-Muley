                ...
                <div className="flex items-center gap-3 w-full">
                    <div className="">
                        <svg width="17" height="22" viewBox="0 0 15 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M11.0299 7.73132C11.0299 9.61083 9.44983 11.1343 7.50078 11.1343C5.55173 11.1343 3.97168 9.61083 3.97168 7.73132C3.97168 5.8518 5.55173 4.32812 7.50078 4.32812C9.44983 4.32812 11.0299 5.8518 11.0299 7.73132Z" fill="#050505" stroke="#916CE7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>
