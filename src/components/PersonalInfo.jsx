  ...
  return (
    <div className="bg-shade_3 bg-opacity-40 border-[0.002px] border-shade_3  flex flex-col gap-5 p-5 rounded-xl ">
      <div className="flex flex-wrap gap-5 justify-center w-full">
        ...
        <div className=" grow shrink basis-[300px] w-full flex-col flex gap-2">
          <div className="flex gap-2 justify-center sm:justify-between">
            ...
            {/* <div className=""> */}
              <div className="sm:flex items-center gap-1 hidden">
                ...
                <div className=" p-2 aspect-square bg-shade_3 rounded-md">
          ...
          <div className="">
            ...
            <p className="text-shade_5  text-center sm:text-left">
              I'm a <span className="text-shade_1">UX Designer</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex w-full flex-wrap gap-2  text-sm md:text-base">
        ...
        >
          <div className="w-full bg-shade_1 bg-opacity-80 hover:bg-opacity-90 transition ease-out duration-100 p-3 rounded-lg flex justify-center items-center gap-3 ">
            ...
            <span className="text-shade_6 font-semibold">Siddhant Bilange</span>
          </div>
        </a>
        <a
          href="mailto:siddhantbilange@gmail.com"
          target="_blank"
          className="w-full grow shrink basis-[200px] "
        >
          <div className="w-full bg-shade_1 bg-opacity-80 hover:bg-opacity-90 transition ease-out duration-100 p-3 rounded-lg flex justify-center items-center gap-3 ">
            ...
            <span className="text-shade_6 font-semibold">siddhantbilange@gmail.com</span>
          </div>
