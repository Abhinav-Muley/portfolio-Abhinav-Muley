            ...
            <div className=" ">
              {first ? (
                <div className=" h-10 w-10 block lg:hidden">
                  <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => setfirst((prev) => !prev)} className="bg-shade_3 hover:bg-shade_4 transition ease-out duration-100 rounded-md">
                    <g clip-path="url(#clip0_2004_1445)">
                      <rect width="48" height="48" rx="10" />
                      <rect width="48" height="48" />
                      <path d="M15 15L33 33" stroke="white" stroke-width="3" stroke-linecap="round" />
                      <path d="M33 15L15 33" stroke="white" stroke-width="3" stroke-linecap="round" />
                    </g>
                    <defs>
                ...
                <>
                  <div className=" h-10 w-10 block lg:hidden">
                    <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => setfirst((prev) => !prev)} className="bg-shade_3 hover:bg-shade_4 transition ease-out duration-100 rounded-md">
                      <g clip-path="url(#clip0_2004_1412)">
                        <rect width="48" height="48" rx="10" />
                        <path d="M10 18.5H38" stroke="white" stroke-width="3" stroke-linecap="round" />
                        <path d="M10 29.5H26.8" stroke="white" stroke-width="3" stroke-linecap="round" />
                      </g>
                      <defs>
            ...
            <div className=" flex gap-3 ">
              <div className=" h-10 w-10 cursor-pointer">
                <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="bg-shade_3 hover:bg-shade_4 transition ease-out duration-100 rounded-full">
                  <g clip-path="url(#clip0_2004_1362)">
              ...
              <div className=" h-10 w-10 cursor-pointer">
                <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="bg-shade_3 hover:bg-shade_4 transition ease-out duration-100 rounded-full">
                  <g clip-path="url(#clip0_2004_1382)">
                    <rect width="48" height="48" rx="10" />
              ...
              <div className=" h-10 w-10 cursor-pointer">
                <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" className="bg-shade_3 hover:bg-shade_4 transition ease-out duration-100 rounded-full">
                  <g clip-path="url(#clip0_2004_1396)">
                    <rect width="48" height="48" rx="10" />
