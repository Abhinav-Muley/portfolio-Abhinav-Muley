...
const Casestudy = () => {
  ...
  return (
    <>
      {/* <section className='flex flex-col gap-5 xl:gap-10 bg-shade_4'>
        <div className="">

          <div className="grid grid-cols-3 gap-5 md:gap-20 px-2 md:px-28 h-[45vh] xl:h-[100vh] bg-shade_8 overflow-hidden">
            <div className="col-span-2 bg-stone-500 mt-20 rounded-md md:rounded-l-xl md:rounded-r-xl overflow-hidden">
              <div id="elementToAnimate" className="relative p-1 md:p-4 flex justify-center md:shadow-inner shadow-shade_3 z-20">
                <img src={caseData.Laptop_1_1} className="shadow-inner" alt="Selected" />
              </div>
            </div>
            <div className="col-span-1 bg-stone-500 mt-32 rounded-t-xl">
              <div id="elementToAnimate" className="relative p-1 md:p-4 flex justify-center md:shadow-inner shadow-shade_3 z-20">
                <img src={caseData.Android_1_1} className="shadow-inner rounded-t-lg" alt="Selected" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className=' flex flex-col gap-5 xl:gap-20'>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 '>
            <div className="grid gap-5 ">
              <div className="grid grid-row-4 gap-3 md:gap-5">
                <div className=" relative flex items-center gap-5">
                  <div className=" z-20 h-full w-full py-5 sm:py-10 px-3 flex justify-center items-center rounded-lg bg-shade_3 bg-opacity-40 border-[0.002px] border-shade_5 border-opacity-20">
              ...
              width={800} /> */}
                ...
                <div className="grid gap-3 h-full md:h-full rounded-lg p-5 overflow-hidden bg-shade_3 bg-opacity-40 border-[0.002px] border-shade_5 border-opacity-20">
                ...
                <div className="grid gap-3 h-full md:h-full rounded-lg p-5 overflow-hidden bg-shade_3 bg-opacity-40 border-[0.002px] border-shade_5 border-opacity-20">
                  ...
                  <div className=" flex flex-wrap gap-3">
                    <div className="h-12 w-12 bg-shade_2 shadow-sm shadow-purple-300 rounded-lg ">
            ...
            <div className=" grid gap-5 relative overflow-hidden">
              ...
              {/* <div className="  absolute z-10 h-[90vh] w-[90vw] bg-shade_1 top-1/2 left-0 translate-x-0 -translate-y-0 backdrop-blur-xl opacity-50"></div> */}
            </div>
